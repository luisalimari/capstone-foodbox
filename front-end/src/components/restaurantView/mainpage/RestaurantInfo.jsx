        ...
        <Grid item xs={5}>
          <div className="container">
            <Typography component="h1" variant="h5">
              Provide Your Restaurant Information Below
            </Typography>
            ...
            <form onSubmit={this.updateInformation}>
              ...
              <FormControl component="fieldset">
                ...
                <RadioGroup row aria-label="status" name="status" value={this.state.status} onChange={event => this.handleChange({status: event.target.value})}>
                  <FormControlLabel value="open" control={<Radio color="black"/>} label="Open" />
                  <FormControlLabel value="close" control={<Radio color="black"/>} label="Close" />
                </RadioGroup>
              </FormControl>
              <Button
                type="submit"
